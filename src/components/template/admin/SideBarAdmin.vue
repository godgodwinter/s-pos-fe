...
<template>
  <div class="drawer-side">
    ...
    <ul
      class="menu p-4 overflow-y-auto w-80 bg-base-200 text-base-content space-y-1 max-w-sm"
    >
        ...
        <div>
          <div class="flex flex-col justify-center w-full">
            <div class="flex justify-center gap-2 w-full">
              ...
              >
                <!-- {{ me }} -->
                {{ isAdmin ? me.name : me.nama }}
              </p>
              <router-link :to="{ name: 'admin-profile' }" v-if="isAdmin">
                <span
      ...
      <li
        :class="[pagesActive == 'pegawai' ? pagesActiveClass : '']"
        v-if="isAdmin"
      >
        <router-link :to="{ name: 'admin-pegawai' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li
        :class="[pagesActive == 'label' ? pagesActiveClass : '']"
        v-if="isAdmin"
      >
        <router-link :to="{ name: 'admin-label' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span class="ml-3">Kategori / Label</span>
        </router-link>
      </li>
      <li :class="[pagesActive == 'produk' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'admin-produk' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li :class="[pagesActive == 'restok' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'admin-restok' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li :class="[pagesActive == 'laporan' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'admin-laporan' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <li :class="[pagesActive == 'laporanrestok' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'admin-laporan-restok' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span class="ml-3">Laporan Restok </span>
        </router-link>
      </li>
      <li :class="[pagesActive == 'laporanlaba' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'admin-laporan-laba' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span class="ml-3">Laporan Laba </span>
        </router-link>
      </li>
    </ul>
  </div>
