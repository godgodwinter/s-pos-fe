...
const getDataDetail = async () => {
    try {
        ...
        data.value = dataDetail.value.transaksi_detail;
...
<template>
                        ...
                        <table class="table table-compact">
                            <tbody>
                                ...
                                <tr>
                                    <td>TOTAL BAYAR</td>
                                    <td>:</td>
                                    <td>{{ Fungsi.formatRupiah(dataDetail.total_bayar, "Rp. ") }}</td>
                                </tr>
                                <tr>
                                    <td>JUMLAH BARANG</td>
                                    <td>:</td>
    ...
    perPageDropdown: [10, 20, 50],
                            ...
                            <template #table-row="props">
                                ...
                                <span v-else-if="props.column.field == 'harga_akhir'">
                                    {{ Fungsi.formatRupiah(props.row.harga_akhir, "Rp. ") }}

                                </span>
                                <span v-else-if="props.column.field == 'total'">
                                    {{ Fungsi.formatRupiah(props.row.harga_akhir * props.row.jml, "Rp. ") }}
