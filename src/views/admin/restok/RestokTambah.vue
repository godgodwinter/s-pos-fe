...
<template>
    ...
    <div class="shadow shadow-lg py-4 px-4">
        ...
        <div class="grid grid-cols-2">
            <div class="shadow shadow-sm ">
                <Form v-slot="{ errors }" @submit="onApply">
                    <div class="py-2 lg:py-4 px-4">
                        ...
                        <label for="name" class="text-sm font-sm italic text-red-500 block mb-2">Cari
                            Jika produk belum ada / tidak ditemukan ?
                            <button class="btn btn-danger">Tambah Produk</button></label>
            ...
            <div class="">
                <div>
                    <h4 class="font-bold text-xl py-2">Keranjang </h4>
