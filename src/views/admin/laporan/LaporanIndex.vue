...
storeAdmin.setPagesActive("laporan");
...
const getData = async () => {
    try {
        // console.log(blnthn);
        const response = await Api.get(`admin/laporan?blnthn=${blnthn.value}`);
                        ...
                        <table class="table table-compact">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{{ dataAsli.jml_barang_terjual }}
                                        <!-- | ({{ dataAsli.jml_jenis_barang_terjual }}
                                        Jenis Barang) -->
                                    </td>
                                </tr>
                            </tbody>
